...
CREATE TABLE `gamedetails` (
  ...
  `matchId` varchar(15) NOT NULL DEFAULT '' COMMENT '对局id',
  `floor` varchar(15) NOT NULL DEFAULT '' COMMENT '对阵楼层',
  `serverName` varchar(63) NOT NULL DEFAULT '' COMMENT '服务器',
  `playerName` varchar(63) NOT NULL DEFAULT '' COMMENT '玩家id',
  `earn` varchar(15) NOT NULL COMMENT '本局经济',
  `KDA` varchar(63) NOT NULL DEFAULT '0/0/0' COMMENT 'KDA',
  ...
  `minionsKilled` int(15) NOT NULL DEFAULT '0' COMMENT '十分钟补兵数',
  `minionsKDA` varchar(63) NOT NULL DEFAULT '0/0/0' COMMENT '十分钟KDA',
  `summonerSkill1` varchar(63) NOT NULL DEFAULT '' COMMENT '所带召唤师技能1',
  `summonerSkill2` varchar(63) NOT NULL DEFAULT '' COMMENT '所带召唤师技能2',
  ...
  KEY `detail_matchId_index` (`matchId`),
  KEY `detail_player_index` (`playerName`)
) ENGINE=InnoDB AUTO_INCREMENT=2773 DEFAULT CHARSET=utf8 COMMENT='对局详细信息';
...
CREATE TABLE `gamematch` (
  ...
  `gameTime` varchar(63) DEFAULT '' COMMENT '游戏时长',
